...
window.__deviceProfilesCache = window.__deviceProfilesCache || [
  { id: "pixel_7_android_14", label: "Pixel 7 Â· Android 14", androidVersionLabel: "Android 14", formFactor: "phone" },
  { id: "pixel_5_android_13", label: "Pixel 5 Â· Android 13", androidVersionLabel: "Android 13", formFactor: "phone" },
  { id: "pixel_tablet_android_14", label: "Pixel Tablet Â· Android 14", androidVersionLabel: "Android 14", formFactor: "tablet" },
  { id: "small_phone_android_12", label: "Small Phone Â· Android 12", androidVersionLabel: "Android 12", formFactor: "phone" }
];
...
function psEnsureJobLayout() {
  ...
  if (!layout) {
    ...
    rail.innerHTML = '<div class="ps-live-placeholder">Waiting for live updatesâ€¦</div>';
